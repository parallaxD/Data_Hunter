...
{
    [InitializeOnLoad]
    public class SmartMergeRegister
    {
        private const string SmartMergeRegisterEditorPrefsKey = "smart_merge_installed";
        ...
        static void MergeRegister()
        {
            try
            {
                ...
                EditorPrefs.SetString(SmartMergeRegisterEditorPrefsKey, VersionKey);
        ...
        static SmartMergeRegister()
        {
            var installedVersionKey = EditorPrefs.GetString(SmartMergeRegisterEditorPrefsKey);
